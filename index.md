...
requesting structured resource identifiers, reported analyses of RRID
adoption found the fraction of antibodies a reader could unambiguously
identify rose sharply, from roughly a quarter to nearly all.
...
- **Validate** structurally and semantically, with conditional packs for
  cell lines (authentication and mycoplasma), organism metadata,
...
- **Deposit** to Zenodo or Figshare, and connect to eLabFTW and
  protocols.io.
- **Provenance**: each editing step is recorded and exportable as
  PROV-JSON and RO-Crate 1.1.
